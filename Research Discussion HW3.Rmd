...
knitr::include_graphics('EEJ.png')
```
...
So, I don't think bias in Recommender Systems is a bad thing. In fact, it is there to help us in being aware of our own biases.
